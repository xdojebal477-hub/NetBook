...
import { PerfilPublicoComponent } from './features/social/perfil-publico/perfil-publico.component';
import { ComunidadesListaComponent } from './features/social/comunidades-lista/comunidades-lista.component';
import { ComunidadChatComponent } from './features/social/comunidad-chat/comunidad-chat.component';
...
export const routes: Routes = [  
  ...
  { path: 'comunidades/:id', component: ComunidadChatComponent },
  { path: '**', redirectTo: '' }  
]; 
